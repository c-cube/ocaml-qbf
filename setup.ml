...
(* OASIS_START *)
(* DO NOT EDIT (digest: 674aa83c6ff739bc6119db83423a3bf0) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_depqbf", []))];
          ...
          ("test_quantor",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_quantor", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/ocaml-qbf";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Ocaml-qbf provides a unified API to several QBF solvers, along with common types for formulas, QCNF and literals and operations such as simplifications and reduction to CNF. It packs: - a binding to quantor, which is shipped with the library - a binding to Depqbf"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build and install the binding \"qbf.quantor\"";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build and install random generators (depends on \"random-generator\")";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "build and install bindings to DEPQBF (requires it to be installed)";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/quantor/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "qbf"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                      ...
                      bs_c_sources = ["quantor_stubs.c"; "quantor_stubs.h"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt =
                        [
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "qbf";
                      lib_findlib_name = Some "quantor";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "qbf";
                           FindlibPackage ("random-generator", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests/quantor";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "qbf";
                           InternalLibrary "qbf-quantor";
                   ...
                   {exec_custom = false; exec_main_is = "test_quantor.ml"});
               Executable
                 ({
                     cs_name = "test_depqbf";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.EFlag "depqbf"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "tests/depqbf";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "qbf";
                           InternalLibrary "qbf-depqbf";
                           FindlibPackage ("oUnit", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {exec_custom = false; exec_main_is = "test_depqbf.ml"});
               Test
                 ({
                     cs_name = "test_depqbf";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_depqbf"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_quantor"
                        ]
                   });
               Doc
                 ({
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir";
                      doc_title = "Qbf bindings to Quantor documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/c-cube/quantor.git";
                      src_repo_browser =
                        Some "https://github.com/c-cube/quantor";
          ...
          conf_custom =
            {
               ...
               post_command =
                 [
                    ...
                    (OASISExpr.EFlag "quantor", Some (("make", ["deps"])))
                 ]
            };
                      ...
                      Some
                        (("mkdir",
                           [
                              ...
                              "&&";
                              "cp";
                              "libs/quantor-3.2/libquantor.a";
                              "libs/picosat-960/libpicosat.a";
                              "_build"
                           ])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
     ...
     oasis_digest = Some "\030\136$\238\198\237h0\165\"aZx\023\162\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
