...
(* OASIS_START *)
(* DO NOT EDIT (digest: f38d50fcb2273b0971746e9b8b5f83bf) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_quantor.ml"});
               Executable
                 ({
                     cs_name = "test_depqbf";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "test_depqbf.ml"});
               Test
                 ({
                     cs_name = "test_depqbf";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest =
       Some "\208\166\153W\231\1902\179\249~\179\212\191[\029\174";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
