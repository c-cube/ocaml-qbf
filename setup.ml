...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6059408f83f43e46327ea8e69a6576f) *)
(*
...
let setup_t =
  {
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim "It packs:";
                 OASISText.Verbatim
                   "- a binding to quantor, which is shipped with the library";
                 OASISText.Verbatim "- a binding to Depqbf"
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/c-cube/ocaml-qbf.git";
                      src_repo_browser =
                        Some "https://github.com/c-cube/ocaml-qbf";
     ...
     oasis_digest = Some "W\2275J\241\253\n\170\251\005\156\201\196\000\207i";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
